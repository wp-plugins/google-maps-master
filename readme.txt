...
* [Advanced Version Link](http://wordpress.techgasp.com/google-maps-master/)

**ONLINE DEMO**

* Right of the page, sidebar widget
* Inside the post, with shortcode framework
* [Demo Link](http://wordpress.techgasp.com/google-maps-master)
...
3. Visit the "Plugin Page | Google Maps Master" to configure settings
4. [Google Maps Master Documentation](http://wordpress.techgasp.com/google-maps-master-documentation/)


== Frequently Asked Questions ==

= Issues with Maps display =
...
* Insert the universal shortcode into any page or post. [google-maps-master-un]
* Insert the individual shortcode into any page or post. [google-maps-master]
* [Advanced Version Link](http://wordpress.techgasp.com/google-maps-master/)
...
= Need More Help =
* [Google Maps Master Documentation](http://wordpress.techgasp.com/google-maps-master-documentation)
...
7. Google Maps Advanced Widget Hybrid View
8. Google Maps Advanced Widget Terrain View
9. Shortcode inside pages and posts. Shortcode framework implementation
